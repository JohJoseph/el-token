...
export const filledOrdersSelector = createSelector(
    ...
    (orders) => {
        ...
        orders = orders.sort((a,b) => a.timstamp - b.timestamp)
        //Decorate orders
...
const decorateOrder = (order) => {
    ...
    return({
        ...order,
        eitherAmount: ether(etherAmount),
...
const tokenPriceClass = (tokenPrice, orderId, previousOrder) => {
    ...
    //Show green price if order price is higher than the previous order
...
export const orderBookSelector = createSelector(
    ...
    (orders) => {
        ...
        orders = {
            ...orders,
            buyOrders: buyOrders.sort((a,b) => b.tokePrice - a.tokenPrice)
        }
        //Fetch buy orders
        ...
        orders = {
            ...orders,
            sellOrders: sellOrders.sort((a,b) => b.tokePrice - a.tokenPrice)
        }
        return orders
    }
)
