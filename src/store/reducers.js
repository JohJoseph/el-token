...
function exchange(state = {}, action) {
	...
	switch (action.type){
		...
		case 'BUY_ORDER_PRICE_CHANGED':
			return { ...state, buyOrder: { ...state.buyOrder, amount: action.price } }
		case 'BUY_ORDER_MAKING':
			return { ...state, buyOrder: { ...state.buyOrder, amount: null, price: null, making: true } }
			
		case 'ORDER_MADE':
		//Prevent duplicateorders
		...
		case 'SELL_ORDER_PRICE_CHANGED':
			return { ...state, sellOrder: { ...state.sellOrder, amount: action.price } }
